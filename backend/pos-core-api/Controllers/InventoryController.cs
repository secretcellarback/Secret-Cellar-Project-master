        ...
        public IActionResult Post([FromBody] Inventory tester)
        {
            ...
            try
            {
                ...
                string sqlStatementDesc = 
                    "SET SQL_MODE = '';INSERT INTO inventory_description " +
                    "(name, supplierID, barcode, retail_price, description, typeID, bottle_deposit_qty, nontaxable, nontaxable_local) " +
                    "VALUES (@name, @supplierID, @barcode, @retailPrice, @description, @typeID, @bottleDepositQty, @nonTaxable, @nonTaxableLocal)";
                ...
                // returns inventoryID of the newly created item.
